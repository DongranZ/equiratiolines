...
namespace Gis.App_Start
{
    internal sealed class LicenseInitializer
    {
        ...
        private bool Initialize()
        {
            ...
            {
                esriLicenseProductCode prod = (esriLicenseProductCode)System.Enum.ToObject(typeof(esriLicenseProductCode), prodNumber);
        ...
        private string ReportInformation(ILicenseInformation licInfo,esriLicenseProductCode code, esriLicenseStatus status)
        {
        ...
        private string ReportInformation(ILicenseInformation licInfo,esriLicenseExtensionCode code, esriLicenseStatus status)
        {
